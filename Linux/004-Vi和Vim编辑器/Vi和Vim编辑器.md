...
![001_vi键盘-w551](Vi和Vim编辑器.assets/001_vi键盘.png)
...
![002_删除交换文件-w1048](Vi和Vim编辑器.assets/002_删除交换文件.png)
...
![003_vi的模式](Vi和Vim编辑器.assets/003_vi的模式.png)
...
![005_移动光标-w551](Vi和Vim编辑器.assets/005_移动光标.png)
...
![004_插入命令-w400](Vi和Vim编辑器.assets/004_插入命令.png)
...
>
> 注意：先按下`CTRL+W`后，再按下面的字母，即可完成相应操作
...
![vim命令速查图](Vi和Vim编辑器.assets/vim命令速查图.png)
